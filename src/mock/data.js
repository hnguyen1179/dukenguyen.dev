...
export const aboutData = {
    ...
    paragraphs: [
        ...
        '<div>Outside of being outside, I enjoy <span class="emphasize">playing video games, listening to music and watching movies</span>. Some of my favorite games include classic JRPG’s like <span class="emphasize">Final Fantasy 9</span>.  I’m a <span class="emphasize">huge jazz fan</span>, but will listen to anything that sounds good. I have too many favorite artists to name, but a few people I have been listening to recently include … (checks notes) <span class="emphasize">{artists}</span> Listed below are the albums covers of some of my most recently played songs, you can click on them to give them a listen. </div>',
