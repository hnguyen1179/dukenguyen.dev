...
export const aboutData = {
    ...
    paragraphs: [
        "<div>I have a <span class='emphasize'>background in design</span> (with an emphasis in <span class='emphasize'>architecture</span>) and also in <span class='emphasize'>economics</span>! Since graduating from the <span class='emphasize'>University of California, Berkeley</span>, I've worked as a <span class='emphasize'>data analyst</span> for a biopharmaceutical start up in <span class='emphasize'>Emeryville, California</span> for two years. Currently, I'm looking to pivot into <span class='emphasize'>front end web development</span> and pursue of life's <span class='emphasize'>passion for code</span>.</div>",
        ...
        '<div>Outside of being outside, I enjoy <span class="emphasize">playing video games, listening to music and watching movies</span>. Some of my favorite games include classic JRPG’s like <span class="emphasize">Final Fantasy 9, Xenogears and Chrono Trigger</span>.  I’m a <span class="emphasize">huge jazz fan</span>, but will listen to anything that sounds good. I have too many favorite artists to name, but a few people I have been listening to recently include … (checks notes) <span class="emphasize">{artists}</span> Listed below are the albums covers of some of my most recently played songs, you can click on them to give them a listen. </div>',
