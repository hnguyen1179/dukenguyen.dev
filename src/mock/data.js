...
export const homeData = {
  ...
  paragraphs: [
    "I’m a web developer with years of experience working at startups of varying scales, including an early stage a16z-backed startup. I specialize in React-based web apps, but am always open to learning new technologies.",
...
export const aboutData = {
  ...
  paragraphs: [
    "<div>I have a <span class='emphasize'>background in design</span> (with an emphasis in <span class='emphasize'>architecture</span>) and also in <span class='emphasize'>economics</span>.</div>",
