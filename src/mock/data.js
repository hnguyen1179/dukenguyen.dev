...
export const aboutData = {
    ...
    paragraphs: [
        ...
        '<div>Outside of being outside, I enjoy <span class="emphasize">playing video games, reading, and watching movies</span>. Some of my favorite games include classic JRPG’s like <span class="emphasize">Final Fantasy 9 and Xenogears</span>.  I’m a huge jazz fan, but will listen to anything that sounds good.</div>',
